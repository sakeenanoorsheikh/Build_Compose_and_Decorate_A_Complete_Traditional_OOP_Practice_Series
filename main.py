...
Student2 : Student = Student("Noori", 90)  
print("Student 1 Details: ", Student1.display())
print(Student1.name, Student2.marks)
...
emp1 : Employee = Employee("Fifi", 5000, "123-45-6789")
print(emp1.name)
print(emp1._salary)
# print(emp1.__ssn)  
print(emp1._Employee__ssn)   # name mangling 
...
teacher : Teacher = Teacher("Fatima Noor", "Mathematics")   
...
rect1 : Rectangle = Rectangle(5.7, 10.4)
...
class Book:
    ...
    def increment_book_count(cls):
        return f"The count of total books is: {cls.total_books}."
...
employee1: Employee = Employee("Fatima Noor", department)

print(f"Employee {employee1.name} works in {employee1.department.get_department_name()} department.")
...
person : Person = Person("Fatima Noor")
print(person.name)   
print(person.greet()) 
